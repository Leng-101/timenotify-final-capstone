    ...
    <div class="row row_outer ">
        ...
        <div class="row row_upper order-sm-1">
            ...
            <div class="col-sm-2 dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li class="text-center"><a href="StudentAddForm.php" class="b">CREATE RECORD</a></li>
                    <li class="text-center"><a href="../report/report.php" class="b">GENERATE REPORT</a></li>
                    <li class="text-center"><a href="../trash_students/studentstable.php" class="b">TRASH</a></li>
        ...
        <div class="row row_inner row_center order-sm-2">
            ...
            <table class="table text-center table-hover ">
                ...
                <tbody>
                    <?php  
                            $sql="Select * from `students` ORDER BY age, lastname, grade_year, strand, course";

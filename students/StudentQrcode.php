<?php
   ...
   // $stud_id=$_GET['stud_id'];// to get from url
        ...
        $studfullname = $_POST['lastname']. " " .$_POST['firstname']. " " .$_POST['middlename']; 
                        ...
                        //Check if the Image Extension is allowed
                            if(!in_array($file_extension, $allowed_extension)) 
                            {
                                ...
                                else 
                                {
                                    ...
                                    $queryAdd = "INSERT INTO `students`(`stud_id`, `studnum`,  `qr_img`, `picture`, `lastname`, `middlename`, `firstname`, `fullname`, `age`, `sex`, `grade_year`, `strand`, `course`, `section`, `department`, `teacher_prof`, `g_email`) 
                                                                VALUES (NULL, '$studnum', '$qrimage', '$name', '$lastname', '$middlename', '$firstname', '$studfullname', '$age', '$sex', '$grade_year', '$strand', '$course', '$section', '$department', '$teacher_professor', '$g_email')";
            ...
            <!-- Creating the ID of the Student w/ QR Code -->
                ...
                <table>
                        <tr>
                            <td>
                                <center>
                                <img src='../assets/logo_icon.png' style=width:10px; height:10px;> 
                                </center>
                            </td>
                            <td>
                                <font size=1>

<?php 
    ...
    if(!isset($_SESSION["t_username_shs"]))
    {
            ...
            <div class="row row_inner order-sm-2 overflow-auto pt-3">
                ...
                <div class=" row order-sm-1">
                        ...
                        <div class="col-sm-11 order-sm-1">
                            <h4> <b><?php echo $_SESSION["t_username_shs"]; ?></b>'s Portal </h4> <br>
                        </div>
                    ...
                    <br><br>
                        <h3 class="text-center fw-bold pt-2">SENIOR HIGH SCHOOL DEPARTMENT</h3> 
                    <br> <br><br>

                    <div class="rowgrade">
                        <!-- SHS FORM ../genreport/genrepmul_shs.php -->
                                ...
                                <div class="row">  
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-1 text-center">
                                            <button formaction="../genreport/genrepmul_shs.php" class="btn btngenreportshs" type="submit">PDF</button>                
                                            <!-- <input type="submit" class="btn btngenreport" name="generate" value="GENERATE"> -->                                   
                                        </div>
                                        <div class="col-sm-1 text-center">
                                            <button class="btn btngenreportshs" name="generateExcel" type="submit">EXCEL</button>                
                                            <!-- <input type="submit" class="btn btngenreport" name="generate" value="GENERATE"> -->                                   
                                        </div>
                                </div>
                        </form> <br><br>
...
<h4 class="text-center fw-bold violet">SYSTEM REPORT</h4> <br>

<?php 
    ...
    {
    session_destroy();
    unset($_SESSION['t_username_grade']);
    header("Location: ../login_teacher.php"); 
    }
    ?>
            ...
            <div class="row row_inner order-sm-2 overflow-auto pt-3">
                ...
                <div class=" row order-sm-1">
                        ...
                        <div class="col-sm-11 order-sm-1">
                            <h4> <b><?php echo $_SESSION["t_username_grade"]; ?></b>'s Portal </h4> <br>
                        </div>
                        </div>
                <div class="row order-sm-2">


                        <h3 class="text-center fw-bold pt-2">GRADE SCHOOL DEPARTMENT</h3> 
                    <br> <br>
                    <div class="rowgrade"><br>
                        
                    <!-- GRADE FORM  ../genreport/genrepmul_grade.php-->
                        <form class="gradeschool" action="../gen_excel/mulreport_grade_excel.php" method="POST">

                            <h4 class="text-center grade1 fw-bold pt-2">EXPORT</h4> <br>
                            <div class="row">  
                                ...
                                <!-- SECTION DROPDOWN -->
                                    ...
                                    <div class="col-sm-1 text-center">
                                        <button formaction="../genreport/genrepmul_grade.php" class="btn btngenreportgrade" type="submit" name="generate">PDF</button>                 
...
<h4 class="text-center  grade1 fw-bold">SYSTEM REPORT</h4> <br>

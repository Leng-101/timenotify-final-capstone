<?php 
    ...
    if(!isset($_SESSION["t_username_col"]))
    {
    ...
    <link rel="stylesheet" type="text/css" href="../css/report_college.css">
            ...
            <div class="row row_inner order-sm-2 overflow-auto pt-3">
                ...
                <div class=" row order-sm-1">
                        ...
                        <div class="col-sm-11 order-sm-1">
                            <h4> <b><?php echo $_SESSION["t_username_col"]; ?></b>'s Portal </h4> <br>
                        </div>
                    ...
                    <br><br>
                        <h3 class="text-center fw-bold pt-2">COLLEGE DEPARTMENT</h3>  <br>
                    <br> <br>
                            ...
                            <h4 class="text-center col fw-bold">COLLEGE DEPARTMENT</h4> <br>
                                <div class="row">  
                                    ...
                                    <!-- DATE DROPDOWN -->
                                        ...
                                        <div class="col-sm-2 text-center d-flex align-items-start mt-1">
                                            <button formaction="../genreport/genrepmul_college.php"  class="btn btngenreport" type="submit">PDF</button>&nbsp            
...
<h4 class="text-center fw-bold col">SYSTEM REPORT</h4> <br>
    ...
    <div class="row overflow-auto row_table2 table-bordered table-responsive-xl order-sm-2">
            ...
            <?php
                    if(isset($gradeandyr) && isset($secList) && isset($date_rec_list) && isset($course_list)  ) {  
          
                        $query="SELECT * FROM `students` 
                        INNER JOIN time_in_records ON students.stud_id = time_in_records.stud_id
                        WHERE section = '$secList' AND grade_year = '$gradeandyr' AND daterec = '$date_rec_list' AND course = '$course_list' ";

...
$outputheader.='<table class="table-bordered">
                    ...
                    <tr> 
                        <th colspan="12">ALL COLLEGE STUDENT RECORDS</th>
                    </tr>
                    <tr> 
                        <th colspan="12"></th>
                    </tr>
...
$output .='
        <table class="table" bordered="1">
                ...
                if(isset($_POST['generateExcel'])){  
                    ...
                    //If the selected box is not empty
                        if(!empty($_POST['gradeyear']) && !empty($_POST['sectionList']) && 
                            !empty($_POST['dateList']) && !empty($_POST['courseList'])) {  
            ...
            // DISPLAY THE DATA BASED ON DROPDOWN BUTTON 
                    $sqlQuery = "SELECT s.stud_id, s.studnum, s.fullname, s.picture, s.age, s.sex, s.grade_year, s.section, s.department, s.teacher_prof, 
                                 s.g_email, s.course, t.daterec, t.time, t.type FROM students s INNER JOIN time_in_records t 
                                 ON s.studnum = t.studnum WHERE s.grade_year = '$coll_grade' AND s.section = '$coll_sec' 
                                 AND s.course = '$coll_course' AND t.daterec = '$coll_date'"; 
    ...
    header("Content-Disposition: attachment; Filename =all_college_record.xls ");

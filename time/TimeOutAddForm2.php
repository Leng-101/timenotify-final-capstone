...
<div class="cont">
    ...
    <div class="row row_outer">
        ...
        <form class="row g-3 row_inner" action="send_out.php" method="post">
            ...
            <div class="col-sm-7">
                ...
                <h5>TIME OUT CONFIRMATION FORM</h5> 
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 order-sm-2">
                    ...
                    <div class="row-md-4"> <br>
                        <center> <img src="<?php echo "../students/picture/".$row['picture'];?>" style="width:250px; height:250px; border:1px gray solid;" alt="student picture"> <center>
                    </div>
                </div>
            ...
            <div class="row buttondiv">
                ...
                <div class="col-md-4 order-sm-2">
                    <button type="submit" name="back" class="btn1"><a href="TimeOutAddForm.php" class="a">DECLINE </a></button>
                    </div>

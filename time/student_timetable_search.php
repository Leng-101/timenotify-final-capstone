<?php 
    ...
    header("Location:../login.php");
        ...
        if(isset($_POST['search'])) {   
                {      
                    header("location:student_timetable_search.php");
                }
            }
    ?>
    ...
    <div class="row row_outer ">
        ...
        <div class="row row_upper order-sm-1">
            ...
            <div class="col-sm-10">
                ...
                <h5>SEARCH IN ALL TIME IN AND TIME OUT RECORDS</h5> 
            </div>
        </div>
        ...
        <div class="row row_inner order-sm-2">
            <div class="row row_center order-sm-1 " >
                ...
                <div class="col-sm-1 btnn">
                    <button type="submit" class="btn3a"><a href="student_timetable.php" class="a">BACK</a></button>
                </div>
            </div>
            <br>
                ...
                <tbody>
                    ...
                    <?php  
                        if(isset($_GET['search']))
                        {
                            ...
                            $query="SELECT * FROM `time_in_records` WHERE CONCAT(daterec,time,studname,studnum,type) LIKE '%$filtervalues%'";

...
<div class="cont">
    ...
    <div class="row row_outer">
        ...
        <form class="row g-3 row_inner" action="TimeInAddForm2.php?studnum=<?php echo $var; ?>" method="get">
    ...
    ?>
                ...
                <div class="col-md-4 order-sm-2">
                    <div class="row-md-4" hidden>
                        ...
                        <input type="text" class="form-control" id="timenum" name="timenum" disabled required>
                    </div>

                    <div class="row-md-4">
                        <label for="stud_id" class="form-label">Student Number:</label>
                        <input type="text" class="form-control" id="studnum" name="studnum"  value="<?= $var ?>" required disabled>
               ...
               if (!empty($var)) {
                ...
                <div class="col-md-3 order-sm-3">
                    ...
                    <div class="row-md-4">
                        ...
                        <input type="text" class="form-control" id="studname" name="studname" value="<?= $fname; ?>" disabled required>
                    </div>
                
                    <div class="row-md-4">
                        <label for="stud_id" class="form-label">Type:</label>
                        <input type="text" class="form-control" id="stud_id" name="stud_id"  value="" placeholder="Time in" disabled required>
                    </div>
                    
                    <div class="row-md-4 ">
                        <label for="date" class="form-label"> Date Record:</label>
                        <input type="text" class="form-control" id="daterec" name="daterec" value="<?php echo date('l, F j, Y'); ?>" disabled required>
                    </div>

                    <div class="row-md-4">
                        <label for="timein" class="form-label">Time in:</label>
                        <input type="text" class="form-control" id="timein" name="timein" placeholder="time now" disabled required>
                    </div>
            ...
            <div class="row buttondiv">
                ...
                <div class="col-md-4 order-sm-2">
                   ...
                   <a href="TimeInAddForm2.php?studnum=<?php echo $var; ?>" id="tonext" class="a">ADD</a>

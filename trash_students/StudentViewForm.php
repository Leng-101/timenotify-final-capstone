        ...
        <form class="row g-3 row_inner" action="#" method="post">
            ...
            <div class="row">
                ...
                <div class="row-md-4">
                    ...
                    <select class="form-select form-select-sm department_textbox" aria-label=".form-select-sm example" id="sex" name="sex" disabled>

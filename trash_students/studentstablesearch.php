                    ...
                    <tbody >
                        <?php  
                                if(isset($_GET['search']))
                                {
                                    ...
                                    $query="SELECT * FROM `s_trash` WHERE  CONCAT(studnum,firstname,lastname,grade_year,strand,course,teacher_prof,section) LIKE '%$filtervalues%' ORDER BY age, lastname";

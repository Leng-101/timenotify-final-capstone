...
$outputheader.='<table class="table-bordered">
                    ...
                    <tr> 
                        <th colspan="12">ALL GRADE SCHOOL STUDENT RECORDS</th>
                    </tr>
                    <tr> 
                        <th colspan="12"></th>
                    </tr>
...
$output .='
        <table class="table" bordered="1">
            ...
            // DISPLAY THE DATA BASED ON DROPDOWN BUTTON 
                    $sqlQuery = "SELECT s.stud_id, s.studnum, s.fullname, s.picture, s.age, s.sex, s.grade_year, s.section, s.department, s.teacher_prof, 
                                 ...
                                 ON s.studnum = t.studnum WHERE s.grade_year = '$grschool_grade' AND s.section = '$grschool_sec' 
                                 AND t.daterec = '$grschool_date'"; 
    ...
    header("Content-Disposition: attachment; Filename =all_grade_school_record.xls ");

...
$timestamp = time();
$time = date("h:i:s A", $timestamp); // not totally accurate
...
$outputheader.='<table class="table-bordered">
                    ...
                    <tr> 
                        <th colspan="12">ALL SENIOR HIGH SCHOOL STUDENT RECORDS</th>
                    </tr>
                    <tr> 
                        <th colspan="12"></th>
                    </tr>
...
header("Content-Disposition: attachment; Filename =all_seniorhigh_record.xls ");

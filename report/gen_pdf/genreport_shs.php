...
function Header()
{
    ...
    $this->Cell(100);
    $this->Cell(104,-4,'ADMIN REPORT - SENIOR HIGH SCHOOL DEPARTMENT' ,0,1,'C');
...
$sql = "SELECT * FROM students WHERE department='Senior High' ORDER BY grade_year,lastname";
$res = mysqli_query($con,$sql);
$count = mysqli_num_rows($res);

$pdf->Cell(39,10,'Number of Records: ',0,0);
$pdf->Cell(15,10,$count,0,1); 
$pdf->Cell(45,5,'Department: Senior High School',0,1);

$pdf->Cell(190,5,' ',0,1, 'C');

$pdf->SetTextColor(146,2,165);
$pdf->Cell(15,10,'No',0,0); 
$pdf->Cell(30,10,'Number',0,0); 
$pdf->Cell(75,10,'Student Name',0,0); 
$pdf->Cell(15,10,'Age',0,0); 
$pdf->Cell(20,10,'Sex',0,0);   
$pdf->Cell(20,10,'Strand',0,0);  
$pdf->Cell(25,10,'Grade',0,0);  
$pdf->Cell(20,10,'Section',0,0); 
$pdf->Cell(35,10,'Teacher',0,1); 
...
while($rows=mysqli_fetch_assoc($result))
    ...
    $pdf->Cell(25,10,$rows['lastname'],0,0);
    $pdf->Cell(25,10,$rows['firstname'],0,0); 
    $pdf->Cell(25,10,$rows['middlename'],0,0);
    $pdf->Cell(15,10,$rows['age'],0,0); 
    $pdf->Cell(20,10,$rows['sex'],0,0); 
    $pdf->Cell(20,10,$rows['strand'],0,0);
    $pdf->Cell(25,10,$rows['grade_year'],0,0);
    $pdf->Cell(20,10,$rows['section'],0,0);
    $pdf->Cell(35,10,$rows['teacher_prof'],0,1);
     }

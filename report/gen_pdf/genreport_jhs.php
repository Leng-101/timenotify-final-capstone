...
function Header()
{
    ...
    $this->Cell(100);
    $this->Cell(104,-4,'ADMIN REPORT - JUNIOR HIGH SCHOOL DEPARTMENT',0,1,'C');
...
$sql = "SELECT * FROM students WHERE department='Junior High' ORDER BY age, grade_year, lastname";
$res = mysqli_query($con,$sql);
$count = mysqli_num_rows($res);

$pdf->Cell(39,10,'Number of Records: ',0,0);
$pdf->Cell(15,10,$count,0,1); 
$pdf->Cell(45,5,'Department: Junior High School',0,1); 
...
while($rows=mysqli_fetch_assoc($result))
    ...
    $pdf->Cell(30,10,$rows['lastname'],0,0);
    ...
    $pdf->Cell(26,10,$rows['grade_year'],0,0);

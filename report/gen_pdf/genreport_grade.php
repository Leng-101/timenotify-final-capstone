...
function Header()
{
    ...
    $this->Cell(100);
    // Title
    $this->Cell(82,20,'TIME NOTIFY MONITORING SYSTEM',0,1,'C');
    
    $this->SetFont('Arial','B',14);
    $this->SetTextColor(27,24,17);
    $this->Cell(100);
    $this->Cell(83,-4,'ADMIN REPORT - ELEMENTARY DEPARTMENT',0,1,'C');
...
$sql = "SELECT * FROM students where department='Grade School' ORDER BY grade_year, lastname";
...
$pdf->Cell(45,5,'Department: Grade School',0,1);

...
<div class="cont">
    <div class="row row_outer ">
        ...
        <div class="row row_upper order-sm-1">
            ...
            <div class="col-sm-3 dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li class="text-center"><a href="gen_pdf/genreport_grade.php" class="b">GENERATE PDF REPORT</a></li>
                    <li class="text-center"><a href="gen_excel/report_grade_excel.php" class="b">GENERATE EXCEL REPORT</a></li>
        ...
        <div class="row row_inner order-sm-2">
                <h4 class="text-center fw-bold">ALL RECORDS FROM GRADE SCHOOL DEPARTMENT</h4> <br> <br>
            ...
            <table class="table table-hover ">
                ...
                <tbody>
                    <?php  
                            $sql="Select * from `students` where department='Grade School' order by age, grade_year, strand, course, lastname";
                            ...
                            if($result){
                                ...
                                else
                                {
                                    ?>
                                    <tr>
                                        <td colspan="10" class="text-center">No grade school records</td>
                                    </tr>
                                    <?php
                                }
                            }
